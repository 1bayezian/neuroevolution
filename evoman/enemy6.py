...
class Enemy(pygame.sprite.Sprite):
    ...
    def update(self, dt, game):
        ...
        if game.time==1:
            ...
            if game.random_ini == 'yes':
                self.rect.x = numpy.random.choice([640,500,400,300])


        # Defines game mode for player action.
        if game.enemy_mode == 'static': # Enemy controlled by static movements.
        ...
        elif game.enemy_mode == 'ai': # Player controlled by AI algorithm.
        ...
        if game.start == 1:
            ...
            if atack3 == 1 and game.enemy_mode == 'ai':
                 self.direction = self.direction * -1
            ...
            if self.resting == 0 and self.just_shoot == 0 and atack2 == 1:
                ...
                if game.sound == "on" and game.player_mode == "human":
